...
export default function AddOrder({ product, currentUser }) {
  ...
  const confirmOrder = (e) => {
        ...
        let headersList = {
          "Authorization": "Basic Y2tfMzZlYzc4MDFhMjQ0ZjBhODIxMWU4NmUzYzg1NWNlMTYwYmQzYzQ4MTpjc18zNWZkNDFlMmVlMmMxYjNiZTc1NzFjMDlmMGRiYzAxNTVmZGEzYTEy",
         ...
         fetch("https://server835762.nazwa.pl/wordpress/wp-json/wc/v3/orders", { 
           method: "POST",
           body: bodyContent,
           headers: headersList

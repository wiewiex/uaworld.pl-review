        ...
        if (imgId) {
          ...
          let headersList = {
           ...
           fetch(`${process.env.NEXT_PUBLIC_WORDPRESS_URL}/wp-json/wc/v3/products`, { 
             ...
             console.log(data);
             setUserMessage(<h2 className={style.userMessage}>Your work has been successfully uploaded. We will contact you by e-mail to arrange the details.</h2>);
           })
            .catch(error => setUserMessage(<h2>{error}</h2>))
